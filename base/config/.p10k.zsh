# Generated by Powerlevel10k configuration wizard on 2021-01-21 at 15:11 AEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 43896.
# Wizard options: compatible, unicode, lean, 12h time, 2 lines, solid, right frame,
...
() {
  ...
  function prompt_rosenv() {
    p10k segment -f 208 -i '🤖' -t '(callum_ws)'
  }
